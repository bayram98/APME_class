"""
Here we demonstrate how to create a file, write something in that file, and read data from a file.
...
if __name__ == '__main__':
    ...
    In the file read.txt, each line contains some data separated by the character "comma" (',')"""
